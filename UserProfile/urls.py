...
from .views import ForgotPasswordView, ResetPasswordView, UserLogoutView, UserProfileUpdateView, UserRegistrationView, UserLoginView, UserProfileView, UserPasswordView
